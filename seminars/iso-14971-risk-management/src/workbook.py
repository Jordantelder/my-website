...
rows = [
    ...
    ("A note on FDA", "ISO 14971 is not incorporated by reference into 21 CFR Part 820. The risk management obligation FDA enforces runs through the ISO 13485:2016 clauses that Part 820 does incorporate, principally 4.1.2 b), 7.1, and the design, purchasing, production and measurement clauses. ISO 14971:2019 is an FDA-recognized consensus standard, so conformance can be declared in a submission; recognition is not incorporation."),
    ("", ""),
