...
Separately, ISO 14971:2019 is an FDA-recognized consensus standard, so you can declare conformity in a submission. Recognition is not incorporation: it supports a submission, it does not create a regulation. Check the current recognition entry before you cite it - recognition numbers and transition notices change.`);
  ...
  band(s, 'ISO 14971:2019 is an FDA-recognized consensus standard. Recognition supports a submission; it does not make the standard law.', { y: 4.72, h: 0.38, fontSize: 10, fill: C.navy });
}
...
Read the three differences out. The AFAP-versus-acceptability difference is the one that changes your file. The individual benefit-risk expectation is the one that changes your record count - Team-NB's April 2025 position paper on technical documentation says plainly that the MDR does not permit risk acceptance on RPN alone or on a "green" zone, and that acceptability of each risk must be decided individually against predefined criteria. The third is a documentation-location difference, not a substance difference.
...
Mention the Team-NB position paper from April 2025 for the documentation expectations: state whether your risk management process is based on EN ISO 14971; no acceptance on RPN alone; no green zone; each risk decided individually against predefined criteria; and a statement that the clinical benefits outweigh all the residual risks. It also expects three distinct risk assessments - design, production and process, and clinical or application - which catches firms that have only the design one.`);
  const steps = [
  ...
  band(s, 'Team-NB position paper on technical documentation, V3, April 2025: no acceptance on RPN alone, no green zone, each risk decided individually against predefined criteria - and three distinct risk assessments: design, production and process, and clinical.', { y: 4.85, h: 0.42, fontSize: 9.5, fill: C.navy });
}
...
One 2026 development worth mentioning: ISO/TS 24971-2:2026, guidance on applying ISO 14971 to machine learning in artificial intelligence, was published in June 2026. It is guidance on applying the standard, not an amendment to it.`);
  table(s, ['Interface', 'What has to agree', 'Where it is required'], [
    ['Risk file and clinical evaluation', 'The risk acceptability criteria in the RM plan and the benefit-risk acceptability parameters in the clinical evaluation plan, based on the state of the art', 'Annex XIV Part A point 1(a); recital 33'],
...
Point at the bottom band rather than reading the list. The material was verified in September 2026. Harmonised-standard citations, MDCG guidance and FDA recognition entries all move, so the facilitator guide carries a pre-delivery accuracy checklist. Tell them the handout has the full source list with the OJ references.`);
  ...
  card(s, { x: M, y: 2.9, w: 4.35, h: 1.45, kicker: 'US LAW', title: 'Primary', fill: C.tint2, titleSize: 11.5, titleH: 0.26,
    body: ['21 CFR Part 820 as in force from 2 February 2026, incorporating ISO 13485:2016 at 820.7', 'QMSR final rule, 89 FR 7496 (2 February 2024)', 'Compliance Program 7382.850, implementation date 2 February 2026', 'FDA recognized consensus standards database'], bodySize: 9, gap: 2 });
  card(s, { x: M + 4.55, y: 2.9, w: 4.45, h: 1.45, kicker: 'GUIDANCE AND POSITION PAPERS', title: 'Secondary, and labelled as such', fill: C.tint2, titleSize: 11.5, titleH: 0.26,
    body: ['MDCG 2021-5 rev.1 on standardisation (what an Annex Z is)', 'MDCG 2025-10 on post-market surveillance (December 2025)', 'MDCG 2019-16 rev.1 on cybersecurity', 'Team-NB position paper on technical documentation, V3, 9 April 2025'], bodySize: 9, gap: 2 });
