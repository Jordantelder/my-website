...
Speaker decks and companion materials for medical device quality and regulatory seminars. Each folder holds the finished files, a README explaining what they are and what to check before presenting, and a `src/` folder with the generators so the material can be edited and rebuilt reproducibly.

| Seminar | Length | Materials |
|---|---|---|
...
These folders are excluded from the deployed static site by `.assetsignore` at the repository root.
